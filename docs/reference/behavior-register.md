...
- **Rows 1–5 make us diverge from upstream by being *stricter* or *more complete*.** A
  ...
  [`docs/guide/porting-from-clojure.md`](../guide/porting-from-clojure.md) (issue #5), which
  links back here for the authoritative list.
